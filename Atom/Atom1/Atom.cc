...
void ChangeSize(GLsizei w, GLsizei h)
{
    ...
    if(w <= h)
        glOrtho(-100.0f, 100.0f, -100.0f / aspectRatio, 100.0f / aspectRatio, -100.0f * 2.0f, 100.0f * 2.0f);
    else
        glOrtho(-100.0f * aspectRatio, 100.0f * aspectRatio, -100.0f, 100.0f, -100.0f * 2.0f, 100.0f * 2.0f);
